...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <asp:GridView ID="grdEnterprises" AutoGenerateColumns="False" runat="server" CssClass="table table-bordered table-hover" EmptyDataText="Nenhum registro foi encontrado." OnRowCommand="grdEnterprises_RowCommand" >
        <Columns>
           ...
           <asp:TemplateField HeaderText="Atividade Corporativa">
                <ItemTemplate>
                    <asp:Label ID="lblAtividade" Text='<%# Eval("CorporateActivy")%>' runat="server" />
                </ItemTemplate>
           </asp:TemplateField>
    ...
    <asp:Button ID="btnNovo" runat="server" Text="Novo Empreendimento" OnClick="btnNovo_Click" />
</asp:Content>

    ...
    <asp:GridView ID="grdUsers" AutoGenerateColumns="False" runat="server" CssClass="table table-bordered table-hover"
        ...
        <Columns>
           ...
           <asp:TemplateField  HeaderText="Opções">
            <ItemTemplate>                
              <asp:Button runat="server" ID="deleteButtom" Text="Excluir" OnClientClick="javascript:if (!confirm('Confirma a exclusão do registro?')) return false;" CommandName="Remove" CommandArgument='<%#Eval("IdUser")%>' />

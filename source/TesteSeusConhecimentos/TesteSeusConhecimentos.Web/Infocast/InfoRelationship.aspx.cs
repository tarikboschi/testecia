...
namespace TesteSeusConhecimentos.Web.Infocast
{
    public partial class InfoRelationship : System.Web.UI.Page
    {
        ...
        private void CarregaDropDownListUsers()
        {
            ...
            listUsers.DataTextField = "FullName";
        ...
        {
            Relationship relationship = new Relationship(idRelationship, new Enterprise { IdEnterprise = Convert.ToInt32(listEmpresa.SelectedValue) }, new User { IdUser = Convert.ToInt32(listUsers.SelectedValue) });
